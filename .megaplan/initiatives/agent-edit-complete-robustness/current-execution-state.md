...
- M2 Slices 1–2 are implemented and independently accepted; Slices 3–6
...
M2 continues from Slices 3–6 in `briefs/m2-native-adapter.md`: move stable
identity and native normalization behind the adapter, route canonical
mutation/inverse/restoration through it, prove incident behavior through real
LiteGraph serialization, and finish the full-milestone ownership and coverage
gates. The S1/S2 acceptance does not claim those later responsibilities.
