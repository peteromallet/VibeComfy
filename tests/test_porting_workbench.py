...
def test_analyze_source_covers_simple_template_and_wan_animate_target() -> None:
    ...
    # T12 Pass 1: SetNode/GetNode broadcast pairs were resolved by the family-P
    # reemit, so helper_nodes is now 0 and helper_broadcast_resolved no longer
    # appears in diagnostics for this template.
