...
test("Sol B2-R4 repro: Python _transaction() fixture validates in the browser", () => {
  ...
  const script = [
    ...
    "from vibecomfy.comfy_nodes.agent.projection_registry_v1 import staged_bundle_metadata_v1",
    "from vibecomfy.schema import NodeSchema, capture_schema_snapshot, schema_payload_from_node_schema, schema_snapshot_to_payload",
    ...
    "schema = NodeSchema(class_type=\"PreviewImage\", pack=\"core\", inputs={}, outputs=[])",
    "schema_snapshot = capture_schema_snapshot(class_types=(\"PreviewImage\",), request_snapshot={\"schemas\": {\"PreviewImage\": schema_payload_from_node_schema(\"PreviewImage\", schema)}, \"missing_classes\": []}, node_classes={\"node-1\": \"PreviewImage\"})",
    "digest = compute_layout_operation_digest(ops, snapshot=schema_snapshot)",
    ...
    "revision_id = \"a\" * 64",
    "parent_revision = \"\"",
    "bundle_digests = staged_bundle_metadata_v1({",
    "    \"revision_id\": revision_id, \"parent_revision\": parent_revision,",
    "    \"workflow_identity\": \"123e4567-e89b-12d3-a456-426614174000\",",
    "    \"python_path\": \"/tmp/candidate.py\", \"semantic_digest\": content_hash(submit),",
    "    \"sidecar_state\": \"absent\", \"ui_digest\": \"\",",
    "})",
    ...
    "    candidate_layout_graph_hash=None, authority_receipt_hash=\"a\" * 64, schema_witness=schema_snapshot_to_payload(schema_snapshot),",
