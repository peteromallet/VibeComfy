    ...
    async def list_tools():
        return [
            ...
            Tool(name="comfy_packs", description="List all node packs with counts",
                 inputSchema={"type": "object", "properties": {}}),
            Tool(name="comfy_read", description="Read workflow JSON as human-readable: pattern (txt2img, v2v), key params (model, steps, cfg), variables, loops, flow",
            ...
            Tool(name="comfy_trace", description="Trace a node's inputs and outputs with slot names",
            ...
            Tool(name="comfy_upstream", description="Find all nodes feeding into a target node",
            ...
            Tool(name="comfy_downstream", description="Find all nodes fed by a source node",
