...
def build() -> VibeWorkflow:
    ...
    PUBLIC_INPUTS = {
        ...
        'width': InputSpec(node=primitiveint, field='value', default=1024),
        'height': InputSpec(node=primitiveint_2, field='value', default=1024),
        'negative_prompt': InputSpec(node=negative, field='text', default=''),
    }
