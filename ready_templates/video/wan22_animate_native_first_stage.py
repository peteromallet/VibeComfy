...
PUBLIC_INPUT_METADATA = {
    ...
    'driving_video': InputSpec(node='7', field='file', default='motion_video.mp4', type='COMBO', required=True, media_semantics='video'),
    ...
    'steps': InputSpec(node='25', field='steps', default=6, type='INT'),
    'fps': InputSpec(node='29', field='fps', default=DEFAULT_FPS, type='FLOAT'),
    'negative_prompt': InputSpec(node='8', field='text', default='low quality, blurry, distorted', type='STRING', media_semantics='text'),
...
READY_METADATA = ReadyMetadata.build(
    ...
    runtime_note='Worker scratchpads patch reference image, motion video, prompt, negative prompt, seed, steps, width, height, frame count, and output options. The current typed route admits mode=animate; replacement mode is not represented by this graph.',
