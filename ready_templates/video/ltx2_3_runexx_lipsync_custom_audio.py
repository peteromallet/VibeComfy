...
READY_METADATA = ReadyMetadata.build(
    ...
    provenance={'source_path': 'ready_templates/sources/custom_nodes/ltxvideo/runexx/LTX-2.3_V2V_Just_Talk_custom_audio_lipsync.json', 'source_id': 'video/ltx2_3_runexx_lipsync_custom_audio', 'upstream_source_id': 'LTX-2.3_V2V_Just_Talk_custom_audio_lipsync', 'source_type': 'api', 'source_workflow_path': 'ready_templates/sources/custom_nodes/ltxvideo/runexx/LTX-2.3_V2V_Just_Talk_custom_audio_lipsync.json', 'output_mode': 'ready_template', 'ready_id': 'video/ltx2_3_runexx_lipsync_custom_audio'},
