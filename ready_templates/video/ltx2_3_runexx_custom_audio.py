...
def build() -> VibeWorkflow:
    ...
    image_load, mask_load = LoadImage(
        image=public('image', default='liam-neeson-in-retribution-ra.jpg', aliases=('input_image',)),
    )
    ...
    primitiveboolean = raw_call('PrimitiveBoolean', '290', value=public('use_lora', default=False))
    ...
    melbandroformermodelloader = raw_call('MelBandRoFormerModelLoader', '370', widget_0=WIDGET__NAME)
