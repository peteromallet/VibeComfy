...
PUBLIC_INPUTS = {
'first_image': InputSpec(node=ref('loadimage'), field='image', default='egyptian_queen.png', aliases=('start_image',)),
'fps': InputSpec(node=ref('primitivefloat'), field='value', default=8, aliases=('output_fps',)),
'frames': InputSpec(node=ref('primitiveint'), field='value', default=9, aliases=('length',)),
'height': InputSpec(node=ref('emptyltxvlatentvideo'), field='height', default=256),
'image': InputSpec(node=ref('loadimage'), field='image', default='egyptian_queen.png', aliases=('input_image',)),
'model': InputSpec(node=ref('lowvramcheckpointloader'), field='ckpt_name', default=MODEL_NAME),
'negative_prompt': InputSpec(node=ref('cliptextencode_2'), field='text', default=DEFAULT_PROMPT_2, aliases=('negative',)),
