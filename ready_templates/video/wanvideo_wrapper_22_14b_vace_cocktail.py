# vibecomfy: manual
"""Sprint 4 Wan 2.2 VACE cocktail production-candidate template."""
...
READY_METADATA = {
    ...
    "source_role": "manual_sprint4_production_candidate_template",
    "source_workflow": None,
    "coverage_tier": "sprint4_production_candidate",
    "approach": "Wan 2.2 VACE cocktail explicit HIGH/HIGH/LOW three-sampler graph",
    ...
    "runtime_note": "Production-candidate template; explicit sampler chain mirrors WGP model switch behavior.",
}
...
def build() -> VibeWorkflow:
    """Build the Sprint 4 Wan 2.2 VACE cocktail workflow."""
    wf = VibeWorkflow(
    ...
    _node(
        ...
        loop_count=0,
        filename_prefix="sprint4_wan22_vace_cocktail",
