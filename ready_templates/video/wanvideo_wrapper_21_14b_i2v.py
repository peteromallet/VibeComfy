...
PUBLIC_INPUTS = {
    ...
    'image': PublicInput(node='image', field='image', default='oldman_upscaled.png', type='IMAGE', required=True, aliases=('input_image',), media_semantics='image'),
    'width': PublicInput(node='image_image', field='width', default=624, type='INT'),
    'height': PublicInput(node='image_image', field='height', default=624, type='INT'),
