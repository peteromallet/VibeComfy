# ORACLE BATCH CHECK-IN — Batch C (schemas ensure --manifest)
...
## REVIEW TARGET
Repo: /Users/peteromalley/Documents/reigh-workspace/vibecomfy-oracle (HEAD 5f3e635f). Delta to review: `git diff b430bbcb..5f3e635f` (exclude .oracle/**). Acceptance criteria: .oracle/plan.md "Checkpoint C" section. Executor claims all tests implemented and green, no functional deviations.
...
## EXECUTOR-NOTED QUIRK (review explicitly)
Executor noted out-of-scope: "running the test file rewrites the committed vibecomfy/porting/cache/object..." (truncated in log — read the full log at .oracle/receipts/batch-C-execution.log). Determine whether tests mutate the committed cache (they must use tmp dirs); if yes, that is a finding.
