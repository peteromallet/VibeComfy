# Fail analysis batch 2 — DeepSeek Flash (READ-ONLY)
...
## Batch scenarios (7)
  - audio-transcribes-audio-appends-text-regenerates [adapt]
  - audio-tts-narration-using-indextts-2 [adapt]
  - image-animatediff-image-to-video-with-latent-composi-17dc9b [inspect]
  - image-animatediff-video-generation-with-vae-d20410 [revise]
  - image-dual-checkpoint-xl-image-generation-with-refin-c9df19 [research]
  - image-gemini-prompt-splitter-and-text-display-workfl-caae97 [research]
  - image-image-comparison-and-enhancement-with-florence-007018 [revise]
