# Fail analysis batch 5 — DeepSeek Flash (READ-ONLY)
...
## Batch scenarios (7)
  - multi-svd-image-to-video-with-animation-builder-99e2a9 [inspect]
  - multi-svd-image-to-video-with-webp-and-png-output-bd3afb [adapt]
