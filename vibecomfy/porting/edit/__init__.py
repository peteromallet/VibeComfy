...
_EXPORT_MODULES = {
    ...
    "AppliedAddNodeSpec": "vibecomfy.porting.edit.apply",
    "ApplyResult": "vibecomfy.porting.edit.apply",
    "GuardResult": "vibecomfy.porting.edit.apply",
    ...
    "ResolvedRemoveNodePlan": "vibecomfy.porting.edit.apply",
    "ResolveResult": "vibecomfy.porting.edit.apply",
    "apply_delta": "vibecomfy.porting.edit.apply",
    "guard_full_ui": "vibecomfy.porting.edit.apply",
