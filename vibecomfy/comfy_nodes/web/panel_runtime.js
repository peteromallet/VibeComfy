...
function createAgentPanelRuntimeState() {
  return {
    ...
    queueGuardHook: null,
    queueGuardApproval: null,
    queueGuardContext: null,
    queueGuardPromptAttempt: null,
    queueGuardPromptAttemptId: 0,
...
export function saveScopeApprovedRecord(scopeId, record) {
  ...
  const detached = Object.freeze({
    ...
    leaseNonce: record.leaseNonce ?? null,
    ...
    queueWrapper: record.queueWrapper ?? null,
    mutationGraph: record.mutationGraph ?? null,
    mutationWrapper: record.mutationWrapper ?? null,
