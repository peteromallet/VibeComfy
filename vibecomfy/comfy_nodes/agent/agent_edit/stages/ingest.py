"""Ingest, convert, and project stage functions for the agent-edit pipeline.

These stages transform the incoming UI graph into a format the agent can work
with (ingest), convert it to Python source (convert), and render a textual
projection for delta-oriented providers (project).
"""
