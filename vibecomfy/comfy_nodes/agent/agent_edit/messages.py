"""Human-readable message builders for agent-edit responses."""
...
# ── join helper (used locally and re-exported) ─────────────────────────
...
def _batch_warning_sentence(
    ...
    *,
    ...
    from ..contracts import FailureEnvelope, FailureKind, TurnOutcome
    ...
    for turn in getattr(state, "batch_turns", ()) or ():
        ...
        for statement in turn.get("statements") or []:
            ...
            if not isinstance(detail, Mapping):
                continue
            rc = detail.get("resolver_candidates")
...
# ── research summary / clarification helpers ───────────────────────────
