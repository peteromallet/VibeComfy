...
def _compact_batch_system_prompt(
    *,
    ...
    return (
        ...
        "- `refuse(kind=\"requires_custom_nodes\"|\"clarify\", missing_classes=[...], feature_absences=[...], evidence=[...], message=\"...\")` — model-selected typed terminal; only after exact structured absence evidence\n"
        ...
        "missing_classes=[...], feature_absences=[...], evidence=[...], message=\"...\")` "
