    ...
    *,
    ...
    if research_only:
        ...
        system = (
            ...
            "If the community evidence is thin or off-topic, refine and re-search: "
            "use more distinctive terms (model name + version, exact node names, "
            "complaint/praise phrases), and scope topic-dense channels via filters "
            "(source_type='discord', channel='<channel>' — e.g. minimax_h3_chatter, "
            "wan_chatter, ltx_chatter, comfyui, *_resources). Repeat until you have "
            "on-topic hits. When you have "
        ...
        "widget change, a missing required input edge when both endpoints already "
        ...
        "rewires, slot-name invention, architecture swaps). Never use positional "
        "widget indices (widget_2, widget_12); use schema field names "
        "(lossless, steps, seed).\n\n"
