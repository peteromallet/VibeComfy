...
_NARRATOR_SYSTEM_PROMPT = (
    ...
    "- If the outcome is a clarification question, ask it politely and name a "
    "concrete next action that would unblock the work; never end with only a "
    "generic phrase such as 'how would you like to proceed?'.\n"
