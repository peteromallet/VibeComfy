...
READY_METADATA = ReadyMetadata.build(
    ...
    provenance={'source': '/Users/peteromalley/Documents/reigh-workspace/Astrid/runs/matrix-minkhole/planning/comfy-inspection/MiniMax_H3_AV_EncodeDecode_Inpaint.json', 'source_kind': 'comfyui_native_subgraph', 'source_sha256': 'bdd3dc3b8ada880291418a622778e6e0bac2072ecf93064898f0cacdbe295715', 'native_expansion': '24 nodes / 28 links', 'diagnostics': [{'kind': 'repaired_output_backlink', 'link_id': 199, 'node_id': '107', 'slot': 1}, {'kind': 'expanded_native_subgraph', 'instance_id': '105', 'definition': 'Image to Video (MiniMax H3)'}], 'unresolved_schema': ['MiniMaxH3ImageToVideo (ComfyUI core PR #15224)', 'CLIPLoader enum minimax (current stale schema cache)']},
)
