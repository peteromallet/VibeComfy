...
- Rank tests that pin `has_compiled_api`: [`tests/test_upload_external_workflows_to_hivemind.py`](../../tests/test_upload_external_workflows_to_hivemind.py) `:74-104`, `tests/test_executor_research.py` `:260-272,885-886,3706-3708`
